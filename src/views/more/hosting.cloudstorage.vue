        ...
        <div class="column-row align-center-bottom">
          <div class="column-33">
            <div class="product-box">
              <div class="product-header">
                <img src="https://cdn.galactiq.net/images/game-icons/minio.svg" alt="" height="96px">
                <h4 style="margin-top: 20px">
                  Cloud Storage 1
                </h4>
                <p>CS1<br /></p>
                <small
                  >Finland (FI), Oklahoma (US)</small
                >
              </div>
              <div class="product-price">
                ${{ $root.$children[0].floatPriceToString(2)
          ...
          <div class="column-33">
            <div class="product-box">
              ...
              <div class="product-price">
                ${{ $root.$children[0].floatPriceToString(4)
                }}<span class="term">/ month</span>
              </div>
              <div class="product-features">
                <ul>
                  <li><strong>2</strong> CPU core</li>
                  <li><strong>2 GB</strong> RAM</li>
                  <li><strong>40 GB</strong> Disk space</li>
                  <li><strong>4 </strong> Backups</li>
                </ul>
                <ul>
                  <li>
                    1 Gbps shared link
          ...
          <div class="column-33">
            <div class="product-box">
              ...
              <div class="product-price">
                ${{ $root.$children[0].floatPriceToString(6)
                }}<span class="term">/ month</span>
              </div>
              <div class="product-features">
                <ul>
                  ...
                  <li><strong>2 GB</strong> RAM</li>
                  <li><strong>60 GB</strong> Disk space</li>
                  <li><strong>4 </strong> Backups</li>
                </ul>
                <ul>
                  <li>
      ...
      <div class="container">
        <div>
          <table>
            ...
            <tbody>
              <tr>
                <td>1GB Extra storage (max 50)</td>
                <td>$0.15 <small>/ month</small></td>
              </tr>
              <tr>
                <td>1 Extra Backup (max 5)</td>
                <td>$0.15 <small>/ month</small></td>
              </tr>
            </tbody>
          </table>
...
<style scoped>
.content-gamebanner {
  background: url(https://cdn.galactiq.net/images/game-backdrops/cloud-storage.png) center center no-repeat;
