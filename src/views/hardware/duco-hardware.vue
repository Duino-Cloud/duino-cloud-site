    ...
    <section class="content-row content-gamebanner">
      <div class="container">
        ...
        >
          ...
          <p>
            This is the hardware list for all of our Duco nodes
          </p>
        </header>
      </div>
    </section>
          ...
          <div class="column-33">
            <div class="product-box">
              <div class="product-header">
                <img src="https://cdn.galactiq.net/images/flags/4x3/us.svg" alt="" width="100px" style="margin-top: calc((64px - 23.73px) / 2); margin-bottom: calc((64px - 23.73px) / 2)">
              ...
              <div class="product-order">
                  <a
                    ...
                    href="/hardware/duco-hardware/us"
                  >
                    <i class=""></i>See Nodes
                  </a>
            </div>
