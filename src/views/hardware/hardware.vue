<template>
  ...
  <style scoped>
  .gamebg-game {
    background: url(https://cdn.galactiq.net/images/hardware/game.png) center center no-repeat;
  }
  .gamebg-vps {
    background: url(https://cdn.galactiq.net/images/hardware/vps.jpg) top center no-repeat;
  }
