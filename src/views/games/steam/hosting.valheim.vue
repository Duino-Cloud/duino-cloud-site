<template>
      ...
      <section class="content-row content-gamebanner">
        <div class="container">
          ...
          >
            ...
            <p>
                Valheim is a survival and sandbox video game by the Swedish developer Iron Gate Studio and published by Coffee Stain Studios
            </p>
          </header>
        </div>
      </section>
      ...
      <div class="column-row align-center-bottom">
          <div class="column-33">
            <div class="product-box">
              <div class="product-header">
                <img src="https://cdn.galactiq.net/images/game-icons/valheim.png" alt="" height="64px">
              ...
              <div class="product-price">
                ${{ $root.$children[0].floatPriceToString(5)
              ...
              <div class="product-features">
                <ul>
                  ...
                  <li><strong>35 GB</strong> Disk space</li>
                </ul>
                <ul>
                </ul>
              </div>
              <div class="product-order">
                <a
                  ...
                  href="https://console.galactiq.net"
                  target="_blank"
                >
            ...
            <div class="product-box">
              ...
              <div class="product-features">
                <ul>
                  ...
                  <li><strong>70 GB</strong> Disk space</li>
                </ul>
                <ul>
                </ul>
              </div>
          ...
          <div class="column-33">
            <div class="product-box">
              ...
              <div class="product-price">
                ${{ $root.$children[0].floatPriceToString(15)
                }}<span class="term">/ month</span>
              </div>
              <div class="product-features">
                <ul>
                  <li><strong>6</strong> CPU cores</li>
                  <li><strong>8 GB</strong> RAM</li>
                  <li><strong>140 GB</strong> Disk space</li>
                </ul>
                <ul>
                </ul>
              </div>
          ...
          <div class="column-33">
            <div class="product-box">
              ...
              <div class="product-features">
                <ul>
                  <li><strong>6</strong> CPU cores</li>
                  <li><strong>12 GB</strong> RAM</li>
                  <li><strong>180 GB</strong> Disk space</li>
                </ul>
                <ul>
                </ul>
              </div>
      ...
      <div class="container">
        <div>
          <table>
            ...
            <tbody>
            <tr>
                <td>Additional Backup (max 4)</td>
                <td>$1.00 /month</td>
            </tr>
            <tr>
                <td>Upgrade to NVME Storage</td>
                <td>$4.00/month</td>
            </tr>
            </tbody>
          </table>
  ...
  <style scoped>
  .content-gamebanner {
    background: url(https://cdn.galactiq.net/images/game-backdrops/valheim.jpg) center center no-repeat;
