<template>
      ...
      <section class="content-row content-gamebanner">
        <div class="container">
          ...
          >
            ...
            <p>
                A free-to-play multiplayer horror game heavily based on the SCP Foundation series
            </p>
          </header>
        </div>
      </section>
          ...
          <div class="column-33">
            <div class="product-box">
              <div class="product-header">
                <img src="https://cdn.galactiq.net/images/game-icons/scpsl.webp" alt="" height="64px">
  ...
  <style scoped>
  .content-gamebanner {
    background: url(https://cdn.galactiq.net/images/game-backdrops/scp.jpg) center center no-repeat;
