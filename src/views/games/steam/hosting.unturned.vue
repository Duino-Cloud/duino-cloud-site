<template>
      ...
      <section class="content-row content-gamebanner">
        <div class="container">
          ...
          >
            ...
            <p>
                Unturned is a free-to-play survival game by Smartly Dressed Games
            </p>
          </header>
        </div>
      </section>
          ...
          <div class="column-33">
            <div class="product-box">
              <div class="product-header">
                <img src="https://cdn.galactiq.net/images/game-icons/unturned.png" alt="" height="64px">
  ...
  <style scoped>
  .content-gamebanner {
    background: url(https://cdn.galactiq.net/images/game-backdrops/unturned.jpg) center center no-repeat;
